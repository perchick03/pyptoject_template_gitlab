...
Source: https://github.com/cjolowicz/cookiecutter-hypermodern-python/blob/main/tools/prepare-github-release.py
"""
import datetime
import subprocess
import sys
...
def kwargs_to_args(kwargs: dict) -> List[str]:
...
def prepare_release(
    *,
    ...
    This creates a new branch, bumps the version, and opens a pull request.
    """
